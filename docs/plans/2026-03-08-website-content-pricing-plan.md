# Website Content & Pricing Updates Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Update email, service names, brand section, and add new pricing packages section to DPU website.

**Architecture:** Direct file modifications for email/services/brands. New PricingSection component following existing patterns (motion animations, Tailwind styling, responsive grid).

**Tech Stack:** React, TypeScript, Framer Motion, Tailwind CSS, Lucide icons

---

### Task 1: Update Email in Footer

**Files:**
- Modify: `src/components/Footer.tsx:114-118`

**Step 1: Update the email address**

Change line 114-117 from:
```tsx
<a
...
git commit -m "chore: update email to info@digitalprofessionalsunwired.com in footer"
```

---

### Task 2: Update Email in Contact Page

**Files:**
- Modify: `src/pages/Contact.tsx:86-91, 167-171`

**Step 1: Update mailto fallback (line 86)**
...
**Step 2: Update displayed email (lines 167-171)**
...
git commit -m "chore: update email to info@digitalprofessionalsunwired.com in contact page"
```

---

### Task 3: Update Service Names in ServicesSection

**Files:**
- Modify: `src/components/ServicesSection.tsx:17-18, 54-55`

**Step 1: Change "Digital PR & Communications" to "Brand Marketing and Consulting"**
...
**Step 2: Change "Digital Design & UX" to "Website Design, Development and UX"**
...
git commit -m "chore: update service names - brand marketing and website design"
```

---

### Task 4: Update Footer Services List

**Files:**
- Modify: `src/components/Footer.tsx:39-46`

**Step 1: Update the services list to match new names**
...
```bash
git add src/components/Footer.tsx
git commit -m "chore: update footer services list with new service names"
```

---

### Task 5: Update Brand Names Section

**Files:**
- Modify: `src/components/CredibilitySection.tsx:173-182`

**Step 1: Update brands array with new brands, bolder styling**

Change lines 173-182:
```tsx
...
git commit -m "feat: add DBS Bank, KTM, Husqvarna, Pril to brands; make bolder"
```

---

### Task 6: Create PricingSection Component
...
git commit -m "feat: add PricingSection component with 4 package tiers"
```

---

### Task 7: Add PricingSection to Index Page

**Files:**
- Modify: `src/pages/Index.tsx`

**Step 1: Import PricingSection**

Add after line 6 (after ServicesSection import):
```tsx
import PricingSection from "@/components/PricingSection";
```

**Step 2: Add PricingSection to page layout**

Add after ServicesSection (after line 17):
```tsx
<PricingSection />
```
...
git commit -m "feat: add PricingSection to homepage after services"
```
...
Run: `npm run dev`
Expected: Site loads, all changes visible:
- New email in footer and contact page
- Updated service names
- Bold brand names with DBS Bank first
- Pricing section visible after services
...
```bash
git add -A
git commit -m "chore: final adjustments for content and pricing updates"
```
...
| File | Change |
|------|--------|
| `Footer.tsx` | Email + services list |
| `Contact.tsx` | Email (2 locations) |
| `ServicesSection.tsx` | 2 service name changes |
| `CredibilitySection.tsx` | Brand names + styling |
| `PricingSection.tsx` | New component (4 packages) |
| `Index.tsx` | Import + render PricingSection |
